 ...
 */
class ArrangementUpdateForm extends CompositeForm
{
    public $previewImage;
    public $detailImage;
    public $slug;
    ...
    public function __construct(Arrangement $arrangement, array $config = [])
    {
    ...
    {
        return [
            [['slug', 'songId', 'formatsId', 'arrangementTypeId', 'offerTypeId'], 'required'],
            [['slug'], 'string', 'max' => 255],
